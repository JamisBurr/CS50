...
function Talkies.draw()
  ...
  -- message box
  local boxW = windowWidth / 2 -- Half the width of the screen
  local boxH = Talkies.height or (windowHeight / 3) - (2 * currentDialog.padding)
  local boxX = (windowWidth - boxW) / 2 -- Center the box horizontally
  local boxY = windowHeight - (boxH + currentDialog.padding) -- Position at bottom (modify if needed) 
